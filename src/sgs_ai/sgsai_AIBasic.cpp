...
sgs::Derive::CardMessage * AIBasic::installEquip() {
	sgs::Derive::CardMessage * returnMessage = 0;
	for (int i = 0; i < myPlayer()->handnum(); ++i) {
...
sgs::Derive::CardMessage * AIBasic::useTao() {
	sgs::Derive::CardMessage * returnMessage = 0;
...
sgs::Derive::CardMessage * AIBasic::useSha() {
	sgs::Derive::CardMessage * returnMessage = 0;
...
sgs::Derive::CardMessage * AIBasic::useJinnang() {
	sgs::Derive::CardMessage * returnMessage = 0;
	using namespace sgs::ConstData;
	for (int i = 0; i < myPlayer()->handnum(); ++i) {
