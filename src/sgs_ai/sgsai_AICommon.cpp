...
void AICommon::chooseGuanxing(std::vector<const sgs::DataType::Card *>&,
...
sgs::DataType::Message * AICommon::wuxieOrNot(
	...
	sgs::Derive::CardMessage * messageToWuxie =
...
sgs::DataType::Message * AICommon::getYiji(const sgs::DataType::Card *,
		const sgs::DataType::Card *) {
	printDebug(
