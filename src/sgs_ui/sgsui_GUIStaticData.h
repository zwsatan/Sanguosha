...
struct GUIStaticData
{
	...
	static sgs::ConstData::PlayerRole getPlayerRole(int playerIndex, bool visible = true);
	static sgs::ConstData::HeroSkill getPlayerSkill(int playerIndex, int skillIndex);
...
private:
	static bool		m_playersCreated;
	static bool		m_debugLogOn;
	static bool		m_gameOver;
	static int		m_options;
	static int		m_package;
	static int		m_fullPlayerCount;
	static int		m_humanPlayerIndex;
